...
void CRender::Render()
{
	...
	/*if (RImplementation.o.ssfx_core) // SSS23: DEPRECATED
	{
		...
		Target->u_setrt(Target->rt_ssfx_hud, nullptr, nullptr, HW.pBaseZB);
	...
	{
		Target->u_setrt(Device.dwWidth, Device.dwHeight, nullptr, nullptr, nullptr, !RImplementation.o.dx10_msaa ? HW.pBaseZB : Target->rt_MSAADepth->pZRT);
