...
void CVulkanPipeline::Create(VkPipelineLayout layout, VkRenderPass renderPass, const xr_vector<VkPipelineShaderStageCreateInfo>& shaderStages, const VkPipelineVertexInputStateCreateInfo& vertexInput, VkPrimitiveTopology topology)
{
    m_layout = layout;
