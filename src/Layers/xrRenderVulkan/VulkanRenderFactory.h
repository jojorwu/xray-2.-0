...
#define RENDER_FACTORY_DECLARE(Class) \
	virtual I##Class* Create##Class() override; \
	virtual void Destroy##Class(I##Class *pObject) override;

class CVulkanRenderFactory : public IRenderFactory
{
public:
#ifndef _EDITOR
...
extern CVulkanRenderFactory VulkanRenderFactoryImpl;
